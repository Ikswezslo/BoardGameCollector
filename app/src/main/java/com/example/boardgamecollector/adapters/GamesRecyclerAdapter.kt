...
class GamesRecyclerAdapter(private val dataSet: ArrayList<Game>,
                           private val onClickFunc: (Game) -> Unit
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.text_row_game, parent, false)
        ctx = parent.context
